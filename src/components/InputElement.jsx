...
const InputElement = ({ label, name, type, propClass, value, onChange, ...props }) => {
  ...
  return (
    <>
      ...
      <input type={type} name={name} className={`${classes} ${propClass}`} value={value} onChange={onChange} {...props} />
    </>
  );
};
